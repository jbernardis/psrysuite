...
class Hyde(District):
	def __init__(self, rr, name, settings):
		...
		with self.nodes[addr] as n:
			...
			self.rr.AddBlock("H21", self, n, addr, [(2, 4)])
			self.rr.AddBlock("H21.E", self, n, addr, [(2, 5)])
			self.rr.AddBlock("HOSWW2", self, n, addr, [(2, 6)])
			self.rr.AddBlock("HOSWW", self, n, addr, [(2, 7)])
			self.rr.AddBlock("HOSWE", self, n, addr, [(3, 0)])
			self.rr.AddBlock("H31", self, n, addr, [(3, 1)])
			self.rr.AddBlock("H32", self, n, addr, [(3, 2)])
			self.rr.AddBlock("H33", self, n, addr, [(3, 3)])
			self.rr.AddBlock("H34", self, n, addr, [(3, 4)])
			self.rr.AddBlock("H12", self, n, addr, [(3, 5)])
			self.rr.AddBlock("H22", self, n, addr, [(3, 6)])
			self.rr.AddBlock("H43", self, n, addr, [(3, 7)])
			self.rr.AddBlock("H42", self, n, addr, [(4, 0)])
			self.rr.AddBlock("H41", self, n, addr, [(4, 1)])
			self.rr.AddBlock("H40", self, n, addr, [(4, 2)])
			self.rr.AddBlock("HOSEW", self, n, addr, [(4, 3)])
			self.rr.AddBlock("HOSEE", self, n, addr, [(4, 4)])
			self.rr.AddBlock("H13.W", self, n, addr, [(4, 5)])
			self.rr.AddBlock("H13", self, n, addr, [(4, 6)])
